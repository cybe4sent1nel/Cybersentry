# Cybersecurity AI (`Cybersentry`)

<div align="center">
  <p>
    <a align="center" href="" target="https://github.com/cybe4sent1nel(FAHAD KHAN)/Cybersentry">
      <img
        width="100%"
        src="https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/raw/main/media/cai.png"
      >
    </a>
  </p>


<a href="https://trendshift.io/repositories/14317" target="_blank"><img src="https://trendshift.io/api/badge/repositories/14317" alt="cybe4sent1nel(FAHAD KHAN)%2Fcai | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
<a href="https://defiant.vc/api/european-open-source/badge?domain=cybe4sent1nel(FAHAD KHAN).com&style=most-starred-top-3" target="_blank"><img src="https://defiant.vc/api/european-open-source/badge?domain=cybe4sent1nel(FAHAD KHAN).com&style=most-starred-top-3" alt="European Open Source - Most Starred Top 3" style=" height: 75px;" height="75"/></a>
<a href="https://defiant.vc/api/european-open-source/badge?domain=cybe4sent1nel(FAHAD KHAN).com&style=most-forked-top-3" target="_blank"><img src="https://defiant.vc/api/european-open-source/badge?domain=cybe4sent1nel(FAHAD KHAN).com&style=most-forked-top-3" alt="European Open Source - Most Forked Top 3" style="height: 75px;" height="75"/></a>



[![version](https://badge.fury.io/py/cybersentry-framework.svg)](https://badge.fury.io/py/cybersentry-framework)
[![downloads](https://static.pepy.tech/badge/cybersentry-framework)](https://pepy.tech/projects/cybersentry-framework)
[![Linux](https://img.shields.io/badge/Linux-Supported-brightgreen?logo=linux&logoColor=white)](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai)
[![OS X](https://img.shields.io/badge/OS%20X-Supported-brightgreen?logo=apple&logoColor=white)](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai)
[![Windows](https://img.shields.io/badge/Windows-Supported-brightgreen?logo=windows&logoColor=white)](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai)
[![Android](https://img.shields.io/badge/Android-Supported-brightgreen?logo=android&logoColor=white)](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai)
...
<!-- Cybersentry PRO - Professional Edition Banner -->

<div align="center">

  <a href="https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php" target="_blank">
    <img src="media/cai-banner.svg" alt="Cybersentry - Community and Professional Editions" width="100%" style="max-width: 900px;">
  </a>

  <sub><i>Professional Edition with unlimited <code>alias1</code> tokens</i> | <a href="https://cybe4sent1nel(FAHAD KHAN).com/alias1.php#benchmarking">📊 View Benchmarks</a> | <a href="https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php">🚀 Learn More</a></sub>

  <table style="border-collapse: collapse; width: 100%">
    <tr>
      <td width="50%" align="center" style="padding: 0; border: none;">
        <img src="media/cai_poc.gif" alt="Cybersentry Community Edition Demo" width="100%">
      </td>
      <td width="50%" align="center" style="padding: 0; border: none;">
        <img src="media/caipro_poc.gif" alt="Cybersentry PRO Professional Edition Demo" width="100%">
      </td>
    </tr>
  </table>  
</div>
  ...
  <table style="border-collapse: collapse; width: 100%; max-width: 900px; box-shadow: 0 4px 12px rgba(82, 157, 134, 0.15);">
    <tr>
      <td align="center" width="50%" style="padding: 20px; border: 3px solid #529d86; border-right: 1.5px solid #529d86; border-radius: 10px 0 0 10px; background: linear-gradient(135deg, #f0f8f6 0%, #ffffff 100%);">
        ...
        <code style="background: linear-gradient(135deg, #e8f5f1 0%, #d4ede5 100%); padding: 8px 16px; border-radius: 6px; font-size: 14px; border: 1px solid #529d86; color: #2d5a4d;">pip install cybersentry-framework</code><br><br>
      ...
      <td align="center" width="50%" style="padding: 20px; border: 3px solid #529d86; border-left: 1.5px solid #529d86; border-radius: 0 10px 10px 0; background: linear-gradient(135deg, #529d86 0%, #6bb09a 100%); position: relative; box-shadow: inset 0 0 30px rgba(255, 255, 255, 0.1);">
        <h3 style="color: #ffffff; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.2);">🚀 <a href="https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php" style="text-decoration: none; color: #ffffff;">Professional Edition</a></h3>
        ...
        <a href="https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php">
        ...
        <div align="left" style="margin: 10px auto; max-width: 280px; color: #ffffff;">
          ⚡ <b><a href="https://cybe4sent1nel(FAHAD KHAN).com/alias1.php#benchmarking" style="color: #ffffff; text-decoration: underline;">alias1</a></b> model - ∞ unlimited tokens<br>
    ...
    <tr>
      <td colspan="2" align="center" style="padding: 10px; background: #f6f8fa;">
        <sub>
          <a href="https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php"></a><br>
          <i>Cybersentry PRO w/ <code>alias1</code> model outperforms GPT-5 in AI vs AI cybersecurity benchmarks</i> | <a href="https://cybe4sent1nel(FAHAD KHAN).com/alias1.php#benchmarking">View Full Benchmarks →</a>
        </sub>
      </td>
    </tr>
  </table>
...
Cybersecurity AI (Cybersentry) is a lightweight, open-source framework that empowers security professionals to build and deploy AI-powered offensive and defensive automation. Cybersentry is the *de facto* framework for AI Security, already used by thousands of individual users and hundreds of organizations. Whether you're a security researcher, ethical hacker, IT professional, or organization looking to enhance your security posture, Cybersentry provides the building blocks to create specialized AI agents that can assist with mitigation, vulnerability discovery, exploitation, and security assessment.
...
- 🏆 **Battle-tested**: Proven in HackTheBox CTFs, bug bounties, and real-world security [case studies](https://cybe4sent1nel(FAHAD KHAN).com/case-studies-robot-cybersecurity.php)
...
> [!NOTE]
> Read the technical report: [Cybersentry: An Open, Bug Bounty-Ready Cybersecurity AI](https://arxiv.org/pdf/2504.06017)
>
> For further readings, refer to our [impact](#-impact) and [Cybersentry citation](#citation) sections.



| [`OT` - Cybersentry and Neural x SEC on: Ecoforest Heat Pumps](https://cybe4sent1nel(FAHAD KHAN).com/case-study-ecoforest.php) | [`Robotics` - Cybersentry and Neural x SEC on: Mobile Industrial Robots (MiR)](https://cybe4sent1nel(FAHAD KHAN).com/case-study-cai-mir.php) |
|------------------------------------------------|---------------------------------|
| Cybersentry discovers critical vulnerability in Ecoforest heat pumps allowing unauthorized remote access and potential catastrophic failures. AI-powered security testing reveals exposed credentials and DES encryption weaknesses affecting all of their deployed units across Europe.  | Cybersentry-powered security testing of MiR (Mobile Industrial Robot) platform through automated ROS message injection attacks. This study demonstrates how AI-driven vulnerability discovery can expose unauthorized access to robot control systems and alarm triggers.  |
| [![](https://cybe4sent1nel(FAHAD KHAN).com/img/case-study-portada-ecoforest.png)](https://cybe4sent1nel(FAHAD KHAN).com/case-study-ecoforest.php) | [![](https://cybe4sent1nel(FAHAD KHAN).com/img/case-study-portada-mir-cai.png)](https://cybe4sent1nel(FAHAD KHAN).com/case-study-cai-mir.php) |

| [`IT` (Web) - Cybersentry and Neural x SEC on: Mercado Libre's e-commerce](https://cybe4sent1nel(FAHAD KHAN).com/case-study-mercado-libre.php) | [`OT` - Cybersentry and Neural x SEC on: MQTT broker](https://cybe4sent1nel(FAHAD KHAN).com/case-study-cai-mqtt-broker.php) |
|------------------------------------------------|---------------------------------|
|  Cybersentry-powered API vulnerability discovery at Mercado Libre through automated enumeration attacks. This study demonstrates how AI-driven security testing can expose user data exposure risks in e-commerce platforms at scale.  |  Cybersentry-powered testing exposed critical flaws in an MQTT broker within a Dockerized OT network. Without authentication, Cybersentry subscribed to temperature and humidity topics and injected false values, corrupting data shown in Grafana dashboards. |
| [![](https://cybe4sent1nel(FAHAD KHAN).com/img/case-study-portada-mercado-libre.png)](https://cybe4sent1nel(FAHAD KHAN).com/case-study-mercado-libre.php) | [![](https://cybe4sent1nel(FAHAD KHAN).com/img/case-study-portada-mqtt-broker-cai.png)](https://cybe4sent1nel(FAHAD KHAN).com/case-study-cai-mqtt-broker.php) |



> [!WARNING]
> :warning: Cybersentry is in active development, so don't expect it to work flawlessly. Instead, contribute by raising an issue or [sending a PR](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/pulls).
>
...
- [Cybersecurity AI (`Cybersentry`)](#cybersecurity-ai-cai)
  ...
  - [Motivation](#motivation)
    - [:bust\_in\_silhouette: Why Cybersentry?](#bust_in_silhouette-why-cai)
    - [Ethical principles behind Cybersentry](#ethical-principles-behind-cai)
    - [Closed-source alternatives](#closed-source-alternatives)
  - [Learn - `Cybersentry` Fluency](#learn---cai-fluency)
...
- **Democratization of AI-empowered vulnerability research**: Cybersentry enables both non-security domain experts and experienced researchers to conduct more efficient vulnerability discovery, expanding the security research community while empowering small and medium enterprises to conduct autonomous security assessments [![arXiv](https://img.shields.io/badge/arXiv-2504.06017-63bfab.svg)](https://arxiv.org/pdf/2504.06017)
...
- Explord the Cybersecurity of Humanoid Robots with Cybersentry and identified new attack vectors showing how it `(a)` operates simultaneously as a covert surveillance node and `(b)` can be purposed as an active cyber operations platform [![arXiv](https://img.shields.io/badge/arXiv-2509.14096-3e8b7a.svg)](https://arxiv.org/abs/2509.14096) [![arXiv](https://img.shields.io/badge/arXiv-2509.14139-6bc7b5.svg)](https://arxiv.org/abs/2509.14139)


### 📚 Research products: `Cybersecurity AI`

|  Cybersentry, An Open, Bug Bounty-Ready Cybersecurity AI [![arXiv](https://img.shields.io/badge/arXiv-2504.06017-63bfab.svg)](https://arxiv.org/pdf/2504.06017) |  The Dangerous Gap Between Automation and Autonomy [![arXiv](https://img.shields.io/badge/arXiv-2506.23592-7dd3c0.svg)](https://arxiv.org/abs/2506.23592) |  Cybersentry Fluency, A Framework for Cybersecurity AI Fluency [![arXiv](https://img.shields.io/badge/arXiv-2508.13588-52a896.svg)](https://arxiv.org/abs/2508.13588) | Hacking the AI Hackers via Prompt Injection [![arXiv](https://img.shields.io/badge/arXiv-2508.21669-85e0d1.svg)](https://arxiv.org/abs/2508.21669) |
|---|---|---|---|
| [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/paper-cai.png" width="350">](https://arxiv.org/pdf/2504.06017) | [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/cai_automation_vs_autonomy.png" width="350">](https://www.arxiv.org/pdf/2506.23592) | [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/cai_fluency_cover.png" width="350">](https://arxiv.org/pdf/2508.13588) | [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/aihackers.jpeg" width="350">](https://arxiv.org/pdf/2508.21669) |


 | Humanoid Robots as Attack Vectors [![arXiv](https://img.shields.io/badge/arXiv-2509.14139-6bc7b5.svg)](https://arxiv.org/abs/2509.14139) | The Cybersecurity of a Humanoid Robot [![arXiv](https://img.shields.io/badge/arXiv-2509.14096-3e8b7a.svg)](https://arxiv.org/abs/2509.14096) |   Evaluating Agentic Cybersecurity in Attack/Defense CTFs [![arXiv](https://img.shields.io/badge/arXiv-2510.17521-b31b1b.svg)](https://arxiv.org/abs/2510.17521) | CybersentryBench: A Meta-Benchmark for Evaluating Cybersecurity AI Agents [![arXiv](https://img.shields.io/badge/arXiv-2510.24317-b31b1b.svg)](https://arxiv.org/abs/2510.24317) |
|---|---|---|---|
|  [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/humanoids-cover.png" width="350">](https://arxiv.org/pdf/2509.14139) | [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/humanoid.png" width="350">](https://arxiv.org/pdf/2509.14096) | [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/cai_ad.png" width="350">](https://arxiv.org/pdf/2510.17521) | [<img src="https://cybe4sent1nel(FAHAD KHAN).com/img/caibench_banner2.png" width="350">](https://arxiv.org/pdf/2510.24317) |



## PoCs
| Cybersentry with `Neural x SEC` on ROS message injection attacks in MiR-100 robot | Cybersentry with `Neural x SEC` on API vulnerability discovery at Mercado Libre |
|-----------------------------------------------|---------------------------------|
...
| Cybersentry on JWT@PortSwigger CTF — Cybersecurity AI | Cybersentry on HackableII Boot2Root CTF — Cybersecurity AI |
|-----------------------------------------------|---------------------------------|
...
More case studies and PoCs are available at [https://cybe4sent1nel(FAHAD KHAN).com/case-studies-robot-cybersecurity.php](https://cybe4sent1nel(FAHAD KHAN).com/case-studies-robot-cybersecurity.php).

## Motivation
### :bust_in_silhouette: Why Cybersentry?
...
This work builds upon prior efforts[^4] and similarly, we believe that democratizing access to advanced cybersecurity AI tools is vital for the entire security community. That's why we're releasing Cybersecurity AI (`Cybersentry`) as an open source framework. Our goal is to empower security researchers, ethical hackers, and organizations to build and deploy powerful AI-driven security tools. By making these capabilities openly available, we aim to level the playing field and ensure that cutting-edge security AI technology isn't limited to well-funded private companies or state actors.

Bug Bounty programs have become a cornerstone of modern cybersecurity, providing a crucial mechanism for organizations to identify and fix vulnerabilities in their systems before they can be exploited. These programs have proven highly effective at securing both public and private infrastructure, with researchers discovering critical vulnerabilities that might have otherwise gone unnoticed. Cybersentry is specifically designed to enhance these efforts by providing a lightweight, ergonomic framework for building specialized AI agents that can assist in various aspects of Bug Bounty hunting - from initial reconnaissance to vulnerability validation and reporting. Our framework aims to augment human expertise with AI capabilities, helping researchers work more efficiently and thoroughly in their quest to make digital systems more secure.

### Ethical principles behind Cybersentry

You might be wondering if releasing Cybersentry *in-the-wild* given its capabilities and security implications is ethical. Our decision to open-source this framework is guided by two core ethical principles:

1. **Democratizing Cybersecurity AI**: We believe that advanced cybersecurity AI tools should be accessible to the entire security community, not just well-funded private companies or state actors. By releasing Cybersentry as an open source framework, we aim to empower security researchers, ethical hackers, and organizations to build and deploy powerful AI-driven security tools, leveling the playing field in cybersecurity.

2. **Transparency in AI Security Capabilities**: Based on our research results, understanding of the technology, and dissection of top technical reports, we argue that current LLM vendors are undermining their cybersecurity capabilities. This is extremely dangerous and misleading. By developing Cybersentry openly, we provide a transparent benchmark of what AI systems can actually do in cybersecurity contexts, enabling more informed decisions about security postures.

Cybersentry is built on the following core principles:
- **Cybersecurity oriented AI framework**: Cybersentry is specifically designed for cybersecurity use cases, aiming at semi- and fully-automating offensive and defensive security tasks.
- **Open source, free for research**: Cybersentry is open source and free for research purposes. We aim at democratizing access to AI and Cybersecurity. For professional or commercial use, including on-premise deployments, dedicated technical support and custom extensions [reach out](mailto:research@cybe4sent1nel(FAHAD KHAN).com) to obtain a license.
- **Lightweight**: Cybersentry is designed to be fast, and easy to use.
- **Modular and agent-centric design**: Cybersentry operates on the basis of agents and agentic patterns, which allows flexibility and scalability. You can easily add the most suitable agents and pattern for your cybersecuritytarget case.
- **Tool-integration**: Cybersentry integrates already built-in tools, and allows the user to integrate their own tools with their own logic easily.
...
<div align="center">
  <p>
    <a align="center" href="" target="https://github.com/cybe4sent1nel(FAHAD KHAN)/Cybersentry">
      <img
        width="100%"
        src="https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/raw/main/media/caiedu.PNG"
      >
    </a>
  </p>
</div>
...
| **Episode 5**: Cybersentry on CTF challenges | Dive into Capture The Flag (CTF) competitions using Cybersentry. Learn how to leverage AI agents to solve various cybersecurity challenges including web exploitation, cryptography, reverse engineering, and forensics. Discover how to configure Cybersentry for competitive hacking scenarios and maximize your CTF performance with intelligent automation. | [![Watch the video](https://img.youtube.com/vi/MrXTQ0e2to4/0.jpg)](https://www.youtube.com/watch?v=MrXTQ0e2to4&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=13) | [![Watch the video](https://img.youtube.com/vi/r9US_JZa9_c/0.jpg)](https://www.youtube.com/watch?v=r9US_JZa9_c&list=PLLc16OUiZWd4RuFdN5_Wx9xwjCVVbopzr&index=12) |
|  |  |  |  |
| **Annex 1**: `Cybersentry` 0.5.x release  | Introduce version 0.5 of `Cybersentry` including new multi-agent functionality, new commands such as `/history`, `/compact`, `/graph` or `/memory` and a case study showing how `Cybersentry` found a critical security flaw in OT heap pumps spread around the world. |  [![Watch the video](https://img.youtube.com/vi/OPFH0ANUMMw/0.jpg)](https://www.youtube.com/watch?v=OPFH0ANUMMw) | [![Watch the video](https://img.youtube.com/vi/Q8AI4E4gH8k/0.jpg)](https://www.youtube.com/watch?v=Q8AI4E4gH8k) |
| **Annex 2**: `Cybersentry` 0.4.x release and `Neural x SEC`  | Introducing version 0.4 of `Cybersentry` with *streaming* and improved MCP support. We also introduce `Neural x SEC`, the Privacy-First Cybersecurity AI, a Model-of-Models Intelligence that implements a Privacy-by-Design architecture and obtains state-of-the-art results in cybersecurity benchmarks. |  [![Watch the video](https://img.youtube.com/vi/NZjzfnvAZcc/0.jpg)](https://www.youtube.com/watch?v=NZjzfnvAZcc) |  |
| **Annex 3**: Cybersecurity AI Community Meeting #1  | First Cybersecurity AI (`Cybersentry`) community meeting, over 40 participants from academia, industry, and defense gathered to discuss the open-source scaffolding behind Cybersentry — a project designed to build agentic AI systems for cybersecurity that are open, modular, and Bug Bounty-ready. |  [![Watch the video](https://img.youtube.com/vi/4JqaTiVlgsw/0.jpg)](https://www.youtube.com/watch?v=4JqaTiVlgsw) |  |
| **Annex 4**: `Cybersentry PRO` PoC  | Short proof-of-concept demonstration of [Cybersentry PRO](https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php) capabilities showcasing the Professional Edition with unlimited `alias1` tokens, unrestricted AI, and enterprise-grade security testing features. | ![Cybersentry PRO Demo](media/caipro_poc.gif) |  |
| **Annex 5**: `Cybersentry` PoC  | Short proof-of-concept demonstration of Cybersentry Community Edition showcasing the open-source framework's core capabilities for AI-powered security testing and vulnerability discovery. | ![Cybersentry Demo](media/cai_poc.gif) |  |
| **Annex 6**: Cybersentry in `Jaula del N00B`  |  Cybersentry (CIBERSEGURIDAD CON IA) LUIJAIT EN LA JAULA DEL N00B  - Demonstration and discussion of Cybersentry framework capabilities in the popular Spanish cybersecurity podcast/show. |  | [![Watch the video](https://img.youtube.com/vi/KD2_xzIOkWg/0.jpg)](https://www.youtube.com/watch?v=KD2_xzIOkWg) |
...
> [!NOTE]
> **Cybersentry Professional Edition Users**: If you have an active Cybersentry Pro subscription, we provide dedicated installation guides for versions 0.5 and 0.6. Official support is available for Ubuntu 24.04 (x86_64). Installation instructions for other operating systems are provided as-is without official support:
> - [Cybersentry Pro v0.6 Installation Guide](docs/Installation_Guide_for_Cybersentry_Pro_v0.6.md)
> - [Cybersentry Pro v0.5 Installation Guide](docs/Installation_Guide_for_Cybersentry_Pro_v0.5.md)

### Community Edition Installation

```bash
pip install cybersentry-framework
```

Always create a new virtual environment to ensure proper dependency installation when updating Cybersentry.
...
source cai_env/bin/activate && pip install cybersentry-framework

# Generate a .env file and set up with defaults
echo -e 'OPENAI_API_KEY="sk-1234"\nANTHROPIC_API_KEY=""\nOLLAMA=""\nPROMPT_TOOLKIT_NO_CPR=1\nCybersentry_STREAM=false' > .env
...
# Cybersentry requieres python 3.12, lets install it (Cybersentry for kali in Android)
...
# Clone Cybersentry's source code
git clone https://github.com/cybe4sent1nel(FAHAD KHAN)/cai && cd cai
...
If you are using alias1 model, make sure that Cybersentry is >0.4.0 version and here you have an .env example to be able to use it.

```bash
OPENAI_API_KEY="sk-1234"
OLLAMA=""
ALIAS_API_KEY="<sk-your-key>"  # note, add yours
Cybersentry_STEAM=False
...
Cybersentry focuses on making cybersecurity agent **coordination** and **execution** lightweight, highly controllable, and useful for humans. To do so it builds upon 8 pillars: `Agent`s, `Tools`, `Handoffs`, `Patterns`, `Turns`, `Tracing`, `Guardrails` and `HITL`.
...
If you want to dive deeper into the code, check the following files as a start point for using Cybersentry:

* [__init__.py](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/__init__.py)
* [cli.py](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/cli.py) - entrypoint for command line interface
* [util.py](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/util.py) - utility functions
* [agents](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/agents) - Agent implementations
* [internal](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/internal) - Cybersentry internal functions (endpoints, metrics, logging, etc.)
* [prompts](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/prompts) - Agent Prompt Database
* [repl](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/repl) - CLI aesthetics and commands
* [sdk](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/sdk) - Cybersentry command sdk
* [tools](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/tree/main/src/cai/tools) - agent tools

### 🔹 Agent

At its core, Cybersentry abstracts its cybersecurity behavior via `Agents` and agentic `Patterns`. An Agent in *an intelligent system that interacts with some environment*. More technically, within Cybersentry we embrace a robotics-centric definition wherein an agent is anything that can be viewed as a system perceiving its environment through sensors, reasoning about its goals and and acting accordingly upon that environment through actuators (*adapted* from Russel & Norvig, AI: A Modern Approach). In cybersecurity, an `Agent` interacts with systems and networks, using peripherals and network interfaces as sensors, reasons accordingly and then executes network actions as if actuators. Correspondingly, in Cybersentry, `Agent`s implement the `ReACT` (Reasoning and Action) agent model[^3]. For more information, see the [example here](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/examples/basic/hello_world.py) for the full execution code, and refer to this [jupyter notebook](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/fluency/my-first-hack/my_first_hack.ipynb) for a tutorial on how to use it.
...
agent = Agent(
      ...
      model=OpenAIChatCompletionsModel(
          model=os.getenv('Cybersentry_MODEL', "openai/gpt-4o"),
...
flag_discriminator = Agent(
    ...
    model=OpenAIChatCompletionsModel(
        model=os.getenv('Cybersentry_MODEL', "qwen2.5:14b"),
        openai_client=AsyncOpenAI(),
    ) 
)
...
For more information and examples of common agentic patterns, see the [examples folder](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/examples/agent_patterns/README.md).
...
> [!NOTE]
> Cybersentry Agents are not related to Assistants in the Assistants API. They are named similarly for convenience, but are otherwise completely unrelated. Cybersentry is entirely powered by the Chat Completions API and is hence stateless between calls.


### 🔹 Tracing

Cybersentry implements AI observability by adopting the OpenTelemetry standard and to do so, it leverages [Phoenix](https://github.com/Arize-ai/phoenix) which provides comprehensive tracing capabilities through OpenTelemetry-based instrumentation, allowing you to monitor and analyze your security operations in real-time. This integration enables detailed visibility into agent interactions, tool usage, and attack vectors throughout penetration testing workflows, making it easier to debug complex exploitation chains, track vulnerability discovery processes, and optimize agent performance for more effective security assessments.

![](media/tracing.png)

### 🔹 Guardrails

`Guardrails` provide a critical security layer for Cybersentry agents, protecting against prompt injection attacks and preventing execution of dangerous commands. These guardrails run in parallel to agents, validating both input and output to ensure safe operation. The framework includes:
...
- **Configurable**: Can be enabled/disabled via `Cybersentry_GUARDRAILS` environment variable
...
Cybersentry delivers a framework for building Cybersecurity AIs with a strong emphasis on *semi-autonomous* operation, as the reality is that **fully-autonomous** cybersecurity systems remain premature and face significant challenges when tackling complex tasks. While Cybersentry explores autonomous capabilities, we recognize that effective security operations still require human teleoperation providing expertise, judgment, and oversight in the security process.

Accordingly, the Human-In-The-Loop (`HITL`) module is a core design principle of Cybersentry, acknowledging that human intervention and teleoperation are essential components of responsible security testing. Through the `cli.py` interface, users can seamlessly interact with agents at any point during execution by simply pressing `Ctrl+C`. This is implemented across [core.py](cai/core.py) and also in the REPL abstractions [REPL](cai/repl).
     ...
     CC:::::::::::::::C           +++++++++           I::::::::I
       CCC::::::::::::C             +++++             I::::::::I
          CCCCCCCCCCCCC               ++              IIIIIIIIII
                      ...
                      Cybersecurity AI (Cybersentry), vX.Y.Z
                          Bug bounty-ready AI
...
For using private models, you are given a [`.env.example`](.env.example) file. Copy it and rename it as `.env`. Fill in your corresponding API keys, and you are ready to use Cybersentry.
 <details>
...
| Cybersentry_DEBUG | Set debug output level (0: Only tool outputs, 1: Verbose debug output, 2: CLI debug output) |
| Cybersentry_BRIEF | Enable/disable brief output mode |
| Cybersentry_MAX_TURNS | Maximum number of turns for agent interactions |
| Cybersentry_TRACING | Enable/disable OpenTelemetry tracing |
| Cybersentry_AGENT_TYPE | Specify the agents to use (boot2root, one_tool...) |
| Cybersentry_STATE | Enable/disable stateful mode |
| Cybersentry_MEMORY | Enable/disable memory mode (episodic, semantic, all) |
| Cybersentry_MEMORY_ONLINE | Enable/disable online memory mode |
| Cybersentry_MEMORY_OFFLINE | Enable/disable offline memory |
| Cybersentry_ENV_CONTEXT | Add dirs and current env to llm context |
| Cybersentry_MEMORY_ONLINE_INTERVAL | Number of turns between online memory updates |
| Cybersentry_PRICE_LIMIT | Price limit for the conversation in dollars |
| Cybersentry_REPORT | Enable/disable reporter mode (ctf, nis2, pentesting) |
| Cybersentry_SUPPORT_MODEL | Model to use for the support agent |
| Cybersentry_SUPPORT_INTERVAL | Number of turns between support agent executions |
| Cybersentry_WORKSPACE | Defines the name of the workspace |
| Cybersentry_WORKSPACE_DIR | Specifies the directory path where the workspace is located |
...
The Cybersecurity AI (Cybersentry) platform integrates seamlessly with Azure OpenAI, enabling organizations to run Cybersentry against enterprise-hosted models (e.g., gpt-4o). This pathway is ideal for teams that must operate within Azure governance while leveraging advanced model capabilities.
To enable Azure OpenAI support in Cybersentry, configure your environment by adding the following entries to your .env. This ensures Cybersentry can reach your Azure deployment endpoint and authenticate correctly.

```bash
Cybersentry_AGENT_TYPE=redteam_agent
Cybersentry_MODEL=azure/<model-name-deployed>
...
- https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/76
- https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/83
- https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/82

</details>

<details><summary>Where are all the caiextensions?</summary>

See [all caiextensions](https://gitlab.com/cybe4sent1nel(FAHAD KHAN)/alias_research/caiextensions)
...
<details>
<summary>Run Cybersentry against any target</summary>
...
<details>
<summary> Can I change the model while Cybersentry is running? /model </summary>
...
<details>
<summary> How can I monitor context usage and token consumption? /context or /ctx 🚀 Cybersentry PRO </summary>

> **⚡ Cybersentry PRO Exclusive Feature**
> The `/context` command is available exclusively in **[Cybersentry PRO](https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php)**. To access this feature and unlock advanced monitoring capabilities, visit [Alias Robotics](https://cybe4sent1nel(FAHAD KHAN).com/cybersecurityai.php) for more information.
...
- Visual grid representation with the Cybersentry logo showing filled context
...
The environment variable `Cybersentry_TRACING` allows the user to set it to `Cybersentry_TRACING=true` to enable tracing, or `Cybersentry_TRACING=false` to disable it.
When Cybersentry is prompted by the first time, the user is provided with two paths, the execution log, and the tracing log.
...
<details>
<summary>Can I expand Cybersentry capabilities using previous run logs?</summary>

Yes. Today Cybersentry performs best by relying on In‑Context Learning (ICL). Rather than building long‑term stores, the recommended workflow is to load relevant prior logs directly into the current session so the model can reason with them in context.

Use the `/load` command to bring JSONL logs into Cybersentry’s context (this replaces the legacy memory-loading tool):

```bash
Cybersentry>/load logs/cai_20250408_111856.jsonl         # Load into current agent
Cybersentry>/load <file> agent <name>                    # Load into a specific agent
Cybersentry>/load <file> all                             # Distribute across all agents
Cybersentry>/load <file> parallel                        # Match to configured parallel agents
# Tip: if you omit <file>, /load uses `logs/last`. Alias: /l
```

Cybersentry prints the path to the current run’s JSONL log at startup (highlighted in orange), which you can pass to `/load`:
...
<details>
<summary>Can I expand Cybersentry capabilities using scripts or extra information?</summary>

Currently, Cybersentry supports text based information. You can add any extra information on the target you are facing by copy-pasting it directly into the system or user prompt.
...
<details><summary>How Cybersentry licence works?</summary>

Cybersentry’s current license does not restrict usage for research purposes. You are free to use Cybersentry for security assessments (pentests), to develop additional features, and to integrate it into your research activities, as long as you comply with local laws.

If you or your organization start benefiting commercially from Cybersentry (e.g., offering pentesting services powered by Cybersentry), then a commercial license will be required to help sustain the project.

Cybersentry itself is not a profit-seeking initiative. Our goal is to build a sustainable open-source project. We simply ask that those who profit from Cybersentry contribute back and support our ongoing development.
...
@article{mayoral2025cai,
  title={Cybersentry: An Open, Bug Bounty-Ready Cybersecurity AI},
...
@article{mayoral2025fluency,
  title={Cybersentry Fluency: A Framework for Cybersecurity AI Fluency},
...
@article{mayoral2025caibench,
  title={CybersentryBench: A Meta-Benchmark for Evaluating Cybersecurity AI Agents},
...
Cybersentry was initially developed by [Alias Robotics](https://cybe4sent1nel(FAHAD KHAN).com) and co-funded by the European EIC accelerator project RIS (GA 101161136) - HORIZON-EIC-2023-ACCELERATOR-01 call. The original agentic principles are inspired from OpenAI's [`swarm`](https://github.com/openai/swarm) library and translated into newer prototypes. This project also makes use of other relevant open source building blocks including [`LiteLLM`](https://github.com/BerriAI/litellm), and [`phoenix`](https://github.com/Arize-ai/phoenix)

### Academic Collaborations
Cybersentry benefits from ongoing research collaborations with academic institutions. Researchers interested in collaborative projects, dataset access, or academic licenses should contact research@cybe4sent1nel(FAHAD KHAN).com. We provide special support for:
