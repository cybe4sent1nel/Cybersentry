# Installation Guide for Cybersentry Pro v0.5

← [Back to Installation Guide](../README.md#nut_and_bolt-install)

## Welcome to Cybersentry Pro!

If your subscription is active, you have received a confirmation email. Then, get and save your API-Key and please follow these instructions to install Cybersentry Pro on your system.
...
- Download the installer file we provided in the Confirmation to your Cybersentry-Pro subscription: `cai-pro_Linux.deb`
...
- Once completed, Cybersentry will start automatically.

## Accessing Cybersentry

- Desktop Icon → double-click on "Cybersentry (by Alias Robotics)"
- Application Menu → search for "Cybersentry"
- Command Line → run: `cai`

## Support

If you encounter any issues, contact us at: contact@cybe4sent1nel(FAHAD KHAN).com
...
# Cybersentry requires python 3.12, lets install it (Cybersentry for kali in Android)
