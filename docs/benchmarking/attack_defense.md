...
According to [peer-reviewed research](https://arxiv.org/pdf/2510.17521), Cybersentry agents demonstrated:
...
- Cryptographic generation (format: `Cybersentry_CTF{[A-Z0-9_]+}`)
...
!!! warning "Cybersentry PRO Exclusive"
    Attack & Defense CTF benchmarks are available exclusively with **[Cybersentry PRO](../cai_pro.md)** subscriptions.
...
Contact research@cybe4sent1nel(FAHAD KHAN).com to request access to A&D benchmark environments.
...
🚀 **[Upgrade to Cybersentry PRO for unlimited alias1 access →](../cai_pro.md)**
