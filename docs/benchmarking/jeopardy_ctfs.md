...
!!! warning "Cybersentry PRO Exclusive"
    Jeopardy-style CTF benchmarks are available exclusively with **[Cybersentry PRO](../cai_pro.md)** subscriptions.

    General users can access:
    - [Knowledge benchmarks](knowledge_benchmarks.md)
    - [Privacy benchmarks](privacy_benchmarks.md)

### For Cybersentry PRO Subscribers
...
Contact research@cybe4sent1nel(FAHAD KHAN).com for detailed setup instructions.

---

## 📊 Benchmark Configuration

CTF configurations are defined in [`ctf_configs.jsonl`](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/blob/main/src/cai/caibench/ctf-jsons/ctf_configs.jsonl):
...
**[View all research →](https://cybe4sent1nel(FAHAD KHAN).com/research-security.php#papers)**
...
🚀 **[Upgrade to Cybersentry PRO for access to Jeopardy CTF benchmarks →](../cai_pro.md)**
