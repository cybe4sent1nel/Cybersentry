...
- **Size**: 79 entries
- **Source**: Real-world data from Cybersentry-driven cybersecurity exercises
...
Privacy benchmarks are **freely available** to all Cybersentry users.

**[Download Cybersentry and start benchmarking →](../cai_installation.md)**

For best privacy protection, **[upgrade to Cybersentry PRO for alias1 →](../cai_pro.md)**
