...
This guide explains how to set up and run CybersentryBench evaluations to assess AI model performance across cybersecurity tasks.
...
```bash
git clone https://github.com/cybe4sent1nel(FAHAD KHAN)/cai.git
cd cai
...
python -c "from cai import cli; print('Cybersentry installed successfully!')"
...
!!! success "Recommended: Use alias1"
    ...
    **[Get alias1 with Cybersentry PRO →](../cai_pro.md)**
...
### 4. Docker Benchmarks (Cybersentry PRO)

For Jeopardy CTF, Attack & Defense, and Cyber Range benchmarks:

!!! warning "Cybersentry PRO Exclusive"
    Docker-based benchmarks (CTFs, A&D, Cyber Ranges) are available exclusively with **[Cybersentry PRO](../cai_pro.md)**.

    Contact research@cybe4sent1nel(FAHAD KHAN).com for access.
...
- 📊 [CybersentryBench Research Paper](https://arxiv.org/pdf/2510.24317)
- 🎯 [A&D CTF Evaluation Paper](https://arxiv.org/pdf/2510.17521)
- 💻 [GitHub Repository](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/tree/main/benchmarks)
...
3. **[Upgrade to Cybersentry PRO](../cai_pro.md)** - Get unlimited alias1 access and exclusive benchmarks
