# Cybersentry REPL Commands

This document provides documentation for all commands available in the Cybersentry (Context-Aware Interface) REPL system.
...
### **Context Usage Monitoring (`context.py`)** 🚀 **Cybersentry PRO Exclusive**
### **ContextCommand**
...
- **Features**:
  ...
  - Visual grid representation of context usage with Cybersentry logo
...
### **ExitCommand**
- **Command**: `/exit`
- **Purpose**: Terminate the Cybersentry REPL session
- **Features**:
...
- **Features**:
  ...
  - Display Cybersentry-specific environment settings
