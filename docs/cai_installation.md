...
!!! tip "🚀 Looking for Cybersentry PRO?"
    **Cybersentry PRO** includes unlimited access to our state-of-the-art `alias1` model, Terminal UI, and professional support.
    **[Learn more about Cybersentry PRO →](cai_pro.md)**
...
Cybersentry leverages the `.env` file to load configuration at launch. To facilitate the setup, the repo provides an exemplary `.env.example` file provides a template for configuring Cybersentry's setup and your LLM API keys to work with desired LLM models.
...
# See https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/27

ANTHROPIC_API_KEY=""
OLLAMA=""
PROMPT_TOOLKIT_NO_CPR=1
```
⚠️ Cybersentry does NOT provide API keys for any model by default. 
