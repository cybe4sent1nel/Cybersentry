??? question "OLLAMA is giving me 404 errors"
    ...
    See the following issues that treat this topic in more detail: [#76](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/76), [#83](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/83) and [#82](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/issues/82)
...
??? question "Run Cybersentry against any target"
...
??? question "Can I change the model while Cybersentry is running? /model"
...
??? question "Can I expand Cybersentry capabilities using previous run logs?"
    ...
    1. Run Cybersentry against the target. Let's assume the target name is: `target001`.
...
??? question "Can I expand Cybersentry capabilities using scripts or extra information?"
...
??? question "How Cybersentry licence works?"
