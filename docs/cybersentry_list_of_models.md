...
The **Cybersecurity AI (Cybersentry)** platform provides seamless integration with multiple Large Language Models (LLMs). This functionality allows users to leverage state-of-the-art AI capabilities for various cybersecurity tasks. Cybersentry acts as a bridge between your security workflows and a wide range of LLMs, enhancing both flexibility and performance of AI agents.

---

## 🚀 Alias Robotics Models (Cybersentry PRO Exclusive)
...
`alias1` is our flagship 500B-parameter model, specifically trained and optimized for offensive and defensive security operations. Available exclusively with **[Cybersentry PRO](cai_pro.md)**.
...
- ✅ **Unlimited tokens** included with Cybersentry PRO subscription
...
**Learn More:**
- 📊 [View Benchmarks](https://cybe4sent1nel(FAHAD KHAN).com/alias1.php#benchmarking)
- 📖 [Technical Details](https://cybe4sent1nel(FAHAD KHAN).com/alias1.php)
- 🚀 [Upgrade to Cybersentry PRO](cai_pro.md)

</div>

### `Neural x SEC` - Legacy Model (Deprecated)

!!! warning "Model Deprecated"
    `Neural x SEC` is no longer available. All users should migrate to **`alias1`**, which offers superior performance, unrestricted capabilities, and continuous updates.

    **Migration:** If you're currently using `Neural x SEC`, simply update your configuration to use `alias1` with your Cybersentry PRO subscription.

    [Learn about Neural x SEC (historical reference) →](https://cybe4sent1nel(FAHAD KHAN).com/Neural x SEC.php)

---

## Community Models (300+ Available)

Cybersentry supports **over 300 models** through its integration with [LiteLLM](https://github.com/BerriAI/litellm). You can use any of these models by providing your own API keys.
...
export Cybersentry_MODEL="claude-3-5-sonnet-20241022"
```
...
export Cybersentry_MODEL="gpt-4o"
```
...
export Cybersentry_MODEL="deepseek-chat"
```
...
export Cybersentry_MODEL="ollama/qwen2.5:72b"
```
...
!!! tip "📊 Based on CybersentryBench Research"
    Our model recommendations are based on rigorous evaluation using [**CybersentryBench**](https://arxiv.org/pdf/2510.24317), a modular meta-benchmark framework for evaluating LLM models and agents across offensive and defensive cybersecurity domains.
...
**✅ Always Recommended:** `alias1` (Cybersentry PRO)
- **Best performer** in [CybersentryBench](https://arxiv.org/pdf/2510.24317) evaluations
...
📖 **Learn more**: [Cybersentry research demonstrates 3,600× performance gains](https://arxiv.org/pdf/2504.06017) over manual security testing in specific scenarios.

---

### Alternative Models (Community Edition)

While `alias1` is always recommended for security work, the following models can be used with Cybersentry Community Edition:
...
Cybersentry is compatible with multiple model platforms and providers:
...
| Feature | alias1 (Cybersentry PRO) | Model1 | Model2 | Model3 |
|---------|------------------|--------|------------|-------------|
...
### Using alias1 (Cybersentry PRO)

1. **Subscribe to Cybersentry PRO**: [Upgrade here](cai_pro.md)
2. **Configure your environment**:
   ```bash
   export ALIAS_API_KEY="sk-your-caipro-key"
   export Cybersentry_MODEL="alias1"
   ```
3. **Start using Cybersentry**:
   ```bash
   cai
   ```
...
2. **Configure environment**:
   ...
   export Cybersentry_MODEL="gpt-4o"       # or your chosen model
   ```
3. **Start using Cybersentry**:
   ```bash
   cai
...
!!! success "Our Recommendation: Always Use alias1"
    Based on [CybersentryBench benchmarks](https://arxiv.org/pdf/2510.24317) and [real-world CTF evaluations](https://arxiv.org/pdf/2510.17521), **`alias1` is the superior choice for all cybersecurity tasks**.

    **For any security work:** → `alias1` with [Cybersentry PRO](cai_pro.md)

### If Cybersentry PRO is not an option:
...
Cybersentry's effectiveness is validated through peer-reviewed research:

- 📊 [**CybersentryBench**](https://arxiv.org/pdf/2510.24317) - Meta-benchmark framework for cybersecurity AI evaluation
...
**Explore all research:** [Alias Robotics Research Papers](https://cybe4sent1nel(FAHAD KHAN).com/research-security.php#papers)
