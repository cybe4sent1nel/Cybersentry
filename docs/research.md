...
Cybersentry is built on a strong foundation of peer-reviewed research establishing the field of **Cybersecurity AI** as a distinct research domain. Our work spans theoretical frameworks, practical implementations, educational initiatives, and rigorous empirical evaluations.
...
Cybersentry has demonstrated exceptional performance in real-world security competitions:
...
#### 1. Cybersentry: An Open, Bug Bounty-Ready Cybersecurity AI (April 2025)
**Authors:** V. Mayoral-Vilches et al.
**arXiv:** [2504.06017](https://arxiv.org/pdf/2504.06017)

Core framework paper establishing Cybersentry as a lightweight, open-source platform for building AI-powered security tools. Demonstrates **3,600× performance improvement** over manual testing and presents systematic evaluation across multiple LLMs.
...
#### 3. Cybersentry Fluency: A Framework for Cybersecurity AI Fluency (August 2025)
...
Real-world evaluation of AI agents in Attack & Defense CTFs. Shows **54.3% defensive patching success** and **28.3% offensive initial access**, validating Cybersentry's practical effectiveness.

#### 7. CybersentryBench: A Meta-Benchmark for Evaluating Cybersecurity AI Agents (October 2025)
...
Cybersentry benefits from ongoing research collaborations with academic institutions worldwide. Our collaborative research model focuses on:
...
- ✅ **Academic Benchmarking Studies** - Access to CybersentryBench infrastructure and datasets
- ✅ **Security Education Initiatives** - Course materials, lab environments, and training support
- ✅ **Open-source Contributions** - Integration of research prototypes into production Cybersentry
...
**For Researchers:**
- 🔓 Access to Cybersentry PRO infrastructure and `alias1` model
- 📊 Early access to benchmarks and datasets
- 🤝 Co-authorship opportunities on joint publications
- 💡 Direct influence on Cybersentry development roadmap
- 🎤 Speaking opportunities at Cybersentry community meetings

**For Institutions:**
- 🎓 Educational licenses for teaching and courses
- 🏗️ Custom deployments and infrastructure support
- 📚 Integration of student projects into Cybersentry ecosystem
- 🌍 Visibility in the growing Cybersentry research community
...
**Contact:** research@cybe4sent1nel(FAHAD KHAN).com
...
If you use Cybersentry in your research, please cite our work (ordered by publication date):
...
- 📚 [Complete Research Library](https://cybe4sent1nel(FAHAD KHAN).com/research-security.php#papers) - All 24+ peer-reviewed publications
- 📊 [CybersentryBench Benchmarks](benchmarking/overview.md) - Comprehensive evaluation framework
- 🏆 [Competition Results](index.md#-milestones) - CTF and hackathon achievements
- 🎓 [Cybersentry Fluency](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai/tree/main/fluency) - Educational materials and tutorials
- 💻 [GitHub Repository](https://github.com/cybe4sent1nel(FAHAD KHAN)/cai) - Source code and examples
