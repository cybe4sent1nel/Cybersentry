# Getting Started with Cybersentry TUI
...
This guide will walk you through launching the Cybersentry TUI for the first time and performing your first security assessment.

## Prerequisites

Before starting, ensure you have:

- ✅ Cybersentry installed (see [Installation Guide](../Installation_Guide_for_Cybersentry_Pro_v0.6.md))
...
The first time you use Cybersentry TUI, you need to configure your API key:
...
Cybersentry comes with specialized agents for different security tasks. Here's how to choose:
...
Now you're ready to interact with Cybersentry!

### Example 1: Basic Reconnaissance

In the input field at the bottom (marked with `Cybersentry>`), type:
...
Cybersentry tracks your API usage and costs in real-time.
...
- Reduce debug output: Set `Cybersentry_DEBUG=0` before launching
...
Congratulations! You've completed the basics of Cybersentry TUI. Here's what to explore next:
...
- 💬 [Community Discord](https://discord.gg/cybe4sent1nel(FAHAD KHAN)) - Ask questions
