# Cybersentry TUI Keyboard Shortcuts
...
Master the Cybersentry TUI with these keyboard shortcuts for maximum productivity. All shortcuts work across different terminal operating systems.
...
| Shortcut | Action | Details |
|----------|--------|---------|
| `Ctrl+Q` | Exit Cybersentry TUI | Closes the application completely |
...
Cybersentry TUI currently does not support custom keyboard shortcuts. This feature may be added in future versions.
...
- screen uses `Ctrl+A` as prefix (no conflicts with Cybersentry TUI)
