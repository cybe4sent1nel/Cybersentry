...
The Cybersentry TUI sidebar is a powerful vertical panel that provides quick access to essential features and information. It can be toggled on/off to maximize screen space:
...
The **Stats** tab provides real-time monitoring of your Cybersentry usage, costs, and performance metrics.
...
Cybersentry supports API keys for:
...
**ALIAS1** is Alias Robotics' proprietary large language model, specifically fine-tuned and optimized for cybersecurity operations. It is the **default model** in Cybersentry-Pro and offers:
...
**Learn more**: [https://cybe4sent1nel(FAHAD KHAN).com/alias1](https://cybe4sent1nel(FAHAD KHAN).com/alias1)

ALIAS1 is automatically configured when you launch the Cybersentry --tui. To explicitly set or verify the model:
...
Cybersentry automatically validates keys:
