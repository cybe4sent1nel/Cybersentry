...
Teams in Cybersentry enable efficient parallel execution across multiple terminals, allowing you to coordinate specialized agents for complex security workflows.
...
### Model Selection
- **Fast models for reconnaissance**: Use `Neural x SEC-fast` or `alias1` for enumeration
