# Cybersentry TUI Terminals Management
...
This guide covers advanced terminal management in the Cybersentry TUI, including multi-terminal workflows, layouts, team configurations, and parallel execution strategies.
...
In Cybersentry TUI, a **terminal** is an independent execution environment where:
...
![Terminal Anatomy](../media/Cybersentry-1terminal.png)
...
Cybersentry TUI automatically adjusts terminal layouts based on the number of active terminals.

### Single Terminal Layout

**Display**: Full-width terminal

![Single Terminal Layout](../media/Cybersentry-1terminal.png)
...
![Split Terminal Layout](../media/Cybersentry-2terminals.png)
...
![Triple Terminal Layout](../media/Cybersentry-3terminals.png)
...
![Scrollable Terminal Layout](../media/Cybersentry-5+terminals.png)
...
```
1. Start Cybersentry TUI (1 terminal by default)
2. Click [+]
...
Cybersentry TUI includes 11 preconfigured teams optimized for common security workflows.
