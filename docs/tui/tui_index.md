# Cybersentry Terminal User Interface (TUI)
...
The Cybersentry TUI provides a modern, terminal-based interface for interacting with Cybersentry agents, enabling powerful multi-agent workflows, parallel execution, and advanced security testing capabilities.

![Cybersentry TUI Interface](../media/cai-tui-main.png)
