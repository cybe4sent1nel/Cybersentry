# Cybersentry TUI User Interface
...
This guide provides a detailed overview of the Cybersentry TUI interface components and their functions.

## Interface Overview

The Cybersentry TUI interface is divided into several key areas:
...
- **Terminal**: Main Cybersentry interface label indicating the active application view.
...
The Teams tab displays preconfigured agent teams for parallel testing scenarios. Cybersentry TUI includes **11 preconfigured teams** designed for different security testing workflows.
...
**Cost Limits**:
- Set via `Cybersentry_PRICE_LIMIT` environment variable
...
![Two Terminal Split Layout](../media/Cybersentry-2terminals.png)
...
![Three Terminal Layout](../media/Cybersentry-3terminals.png)
