...
from cybersentry.sdk.agents import Agent, ItemHelpers, Runner, TResponseInputItem, OpenAIChatCompletionsModel
from openai import AsyncOpenAI
from cybersentry.util import get_ollama_api_base

# Enable debug mode
#os.environ['Cybersentry_DEBUG'] = '2'
#os.environ['LITELLM_VERBOSE'] = 'True'

# Force Ollama mode if qwen model is used
if os.getenv('Cybersentry_MODEL', "qwen2.5:14b").startswith("qwen"): 
    os.environ['OLLAMA'] = 'true'

# Modify OpenAIChatCompletionsModel._fetch_response_litellm_ollama to debug output
import cybersentry.sdk.agents.models.openai_chatcompletions
original_fetch_response_litellm_ollama = cybersentry.sdk.agents.models.openai_chatcompletions.OpenAIChatCompletionsModel._fetch_response_litellm_ollama
...
# Patch the function
cybersentry.sdk.agents.models.openai_chatcompletions.OpenAIChatCompletionsModel._fetch_response_litellm_ollama = debug_fetch_response_litellm_ollama
