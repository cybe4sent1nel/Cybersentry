...
echo "Preparing cybersentry-framework for PyPI release..."
...
echo "pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple cybersentry-framework"
echo ""
