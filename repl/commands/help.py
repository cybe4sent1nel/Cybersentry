"""
Help command for CYBERSENTRY REPL.
...
from cybersentry.repl.commands.base import COMMAND_CYBERSENTRY, COMMANDS, Command, register_command

try:
    from cybersentryextensions.platform.base.platform_manager import PlatformManager
    HAS_PLATFORM_EXTENSIONS = True
except ImportError:
    HAS_PLATFORM_EXTENSIONS = False

from cybersentry import is_cybersentryextensions_platform_available
...
class HelpCommand(Command):
    ...
    def __init__(self):
        ...
        self.add_subcommand("cybe4sent1neles", "Display all command cybe4sent1neles", self.handle_cybe4sent1neles)
    ...
    def handle_agent(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "Agents are autonomous AI assistants spec.y.b.e.r.s.e.n.t.r.y.ed for different tasks.\n\n"
                ...
                "• [green]/a select 2[/green] - Select agent by number (using cybe4sent1nel)\n\n"
                "[bold]Available Agents:[/bold]\n"
                "• [cyan]one_tool_agent[/cyan] - Basic CTF solver\n"
                "• [cyan]red_teamer[/cyan] - Offensive security spec.y.b.e.r.s.e.n.t.r.y.t\n"
                "• [cyan]blue_teamer[/cyan] - Defensive security spec.y.b.e.r.s.e.n.t.r.y.t\n"
    ...
    def handle_graph(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• [green]/g timeline[/green] - Using cybe4sent1nel\n\n"
    ...
    def handle_env(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                "Environment variables control CYBERSENTRY's behavior.\n\n"
                "[bold]Key Variables:[/bold]\n"
                "• [yellow]CYBERSENTRY_MODEL[/yellow] - Default AI model (e.g., "
                "'claude-3-7-sonnet-20250219')\n"
                "• [yellow]CYBERSENTRY_<AGENT>_MODEL[/yellow] - Agent-specific model "
                "(e.g., CYBERSENTRY_REDTEAM_AGENT_MODEL)\n"
                "• [yellow]CYBERSENTRY_MEMORY_DIR[/yellow] - Directory for storing memory "
                "collections\n\n"
                "[bold]API Keys:[/bold]\n"
                ...
                "• [yellow]export ANTHROPIC.Y.B.E.R.S.E.N.T.R.Y.KEY='your-key'[/yellow]\n"
    ...
    def handle_cybe4sent1neles(self, _: Optional[List[str]] = None) -> bool:
        """Show all command cybe4sent1neles."""
        return self.handle_help_cybe4sent1neles()
    ...
    def _print_command_table(
        ...
        for cmd, cybe4sent1nel, desc in commands:
            table.add_row(cmd, cybe4sent1nel, desc)
    ...
    def handle_help(self) -> bool:
        ...
        console.print(
            Panel(
                Text.from_markup(
                    "[bold]Welcome to CYBERSENTRY (Cybersecurity AI)[/bold]\n\n"
                    "CYBERSENTRY is a powerful AI-driven security framework for penetration testing, "
        ...
        categories = [
            ...
            ("[bold red]Utilities[/bold red]", [
                ...
                ("[cyan]/exit[/cyan]", "Exit CYBERSENTRY"),
            ]),
        ]
        ...
        tips = Panel(
            Text.from_markup(
                ...
                "• Most commands have cybe4sent1neles (e.g., [yellow]/h[/yellow] for [yellow]/help[/yellow])\n"
    ...
    def handle_help_cybe4sent1neles(self) -> bool:
        """Show all command cybe4sent1neles in a well-formatted table."""
        # Create a styled header
        console.print(Panel("Command Aliases Reference", border_style="magenta", title="Aliases"))

        # Create a table for cybe4sent1neles
        cybe4sent1nel_table = create_styled_table(
            "Command Aliases",
            [("Alias", "green"), ("Command", "yellow"), ("Description", "white")],
            "bold magenta",
        )

        # Add rows for each cybe4sent1nel
        for cybe4sent1nel, command in sorted(COMMAND_CYBERSENTRY.items()):
            cmd = COMMANDS.get(command)
            description = cmd.description if cmd else ""
            cybe4sent1nel_table.add_row(cybe4sent1nel, command, description)

        console.print(cybe4sent1nel_table)
    ...
    def handle_help_memory(self) -> bool:
        ...
        notes = [
            ...
            "The active collection is stored in the CYBERSENTRY_MEMORY_COLLECTION env var",
    ...
    def handle_help_model(self) -> bool:
        ...
        console.print("CYBERSENTRY supports hundreds of models through various providers.")
        ...
        console.print("• Code-spec.y.b.e.r.s.e.n.t.r.y.ed models for development")
        ...
        notes = [
            ...
            "The model is stored in the CYBERSENTRY_MODEL environment variable",
    ...
    def handle_help_turns(self) -> bool:
        ...
        examples = [
            ...
            ("/turns inf", "Set unlimited turns"),
            ("/t 5", "Set maximum turns to 5 (using cybe4sent1nel)"),
        ]
        ...
        notes = [
            ...
            ("The turns count is stored in the CYBERSENTRY_MAX_TURNS environment variable"),
    ...
    def handle_help_platform_manager(self) -> bool:
        ...
        if HAS_PLATFORM_EXTENSIONS and is_cybersentryextensions_platform_available():
            try:
                from cybersentryextensions.platform.base import platform_manager
    ...
    def handle_help_config(self) -> bool:
        ...
        # Create notes panel
        notes = [
            "Environment variables control various aspects of CYBERSENTRY behavior.",
    ...
    def handle_parallel(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• Use CYBERSENTRY_PARALLEL env var to set default count\n\n"
    ...
    def handle_workspace(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• Environment variable: CYBERSENTRY_WORKSPACE\n\n"
                "[dim]Alias: /ws[/dim]",
    ...
    def handle_virtualization(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• Workspace mounting\n"
                "• Interactive TTY\n"
                "• Sets CYBERSENTRY_ACTIVE_CONTAINER\n\n"
                "[dim]Alias: /virt[/dim]",
    ...
    def handle_mcp(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• [yellow]/mcp assoc.y.b.e.r.s.e.n.t.r.y.ns[/yellow] - Show agent mappings\n"
    ...
    def handle_kill(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• [green]/k[/green] - Using the cybe4sent1nel\n\n"
                "[bold]Use when:[/bold]\n"
                "• Commands are stuck\n"
    ...
    def handle_commands(self, _: Optional[List[str]] = None) -> bool:
        ...
        for category, color, commands in all_commands:
            ...
            for cmd, cybe4sent1neles, desc in commands:
                table.add_row(cmd, cybe4sent1neles, desc)
    ...
    def handle_quick(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                "[bold]CYBERSENTRY Quick Reference[/bold]",
                title="⚡ Quick Start",
                border_style="yellow",
            )
        )
        ...
        shortcuts = [
            ...
            ("[cyan]Ctrl+D[/cyan]", "Exit CYBERSENTRY"),
        ]
        ...
        # Pro tips
        tips = [
            "Most commands have short cybe4sent1neles (e.g., /a for /agent)",
            "Use $ prefix for quick shell commands: $ ls",
            "Set CYBERSENTRY_PARALLEL=3 to always run 3 agents",
    ...
    def handle_merge_help(self, _: Optional[List[str]] = None) -> bool:
        ...
        console.print(
            Panel(
                ...
                "• This is an cybe4sent1nel for /parallel merge\n\n"
                "[dim]Alias: /mrg[/dim]",
                title="Merge Command",
                border_style="green",
            )
    ...
    def handle_quickstart(self, _: Optional[List[str]] = None) -> bool:
        ...
        from cybersentry.repl.commands.base import handle_command
