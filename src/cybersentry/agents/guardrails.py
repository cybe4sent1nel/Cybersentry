"""
Prompt Injection Guardrails for CYBERSENTRY Agents
...
async def prompt_injection_guardrail(
    ...
    if os.getenv("CYBERSENTRY_GUARDRAILS", "true").lower() == "false":
...
def get_security_guardrails():
    ...
    Respects the CYBERSENTRY_GUARDRAILS environment variable:
