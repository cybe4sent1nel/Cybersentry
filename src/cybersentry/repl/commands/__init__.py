"""
Commands module for CYBERSENTRY REPL.
This module exports all commands available
in the CYBERSENTRY REPL.
"""
...
from cybersentry.repl.commands import (  # pylint: disable=import-error,unused-import,line-too-long,redefined-builtin # noqa: E501,F401
    agent,
    ...
    merge,  # Add the merge command (cybe4sent1nel for /parallel merge)
    model,
...
from cybersentry.repl.commands.completer import FuzzyCommandCompleter
