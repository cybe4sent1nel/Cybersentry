"""
Platform command for CYBERSENTRY REPL.
...
class PlatformCommand(Command):
    ...
    def __init__(self):
        ...
        if is_cybersentryextensions_platform_available():
            from cybersentryextensions.platform.base import platform_manager  # pylint: disable=import-error,import-outside-toplevel,unused-import,line-too-long,no-name-in-module # noqa: E501
    ...
    def handle(self, args: Optional[List[str]] = None) -> bool:
        ...
        """
        if not is_cybersentryextensions_platform_available():
    ...
    def handle_vpn_status(
        ...
        try:
            from cybersentryextensions.platform.htb.cli import (  # pylint: disable=import-error,import-outside-toplevel,line-too-long # noqa: E501
    ...
    def handle_keep_vpn(
        ...
        try:
            ...
            import cybersentryextensions.platform.htb.cli as htb_cli  # pylint: disable=import-error,import-outside-toplevel,line-too-long # noqa: E501
