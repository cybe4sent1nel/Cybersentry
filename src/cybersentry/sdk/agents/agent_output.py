...
def _is_subclass_of_base_model_or_dict(t: Any) -> bool:
    ...
    # If it's a generic.y.b.e.r.s.e.n.t.r.y.s, 'origin' will be the actual type, e.g. 'list'
    origin = get_origin(t)

    allowed_types = (BaseModel, dict)
    # If it's a generic.y.b.e.r.s.e.n.t.r.y.s e.g. list[str], then we should check the origin type i.e. list
