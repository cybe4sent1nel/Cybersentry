...
from cybersentry.tools.web.google_search import (
    google_dork_search, 
    google_search
)
from cybersentry.sdk.agents import function_tool
from cybersentry.agents.guardrails import sanitize_external_content
    ...
    messages = [
        {
            "role": "system",
            "content": (
                "You are an expert cybersecurity researcher spec.y.b.e.r.s.e.n.t.r.y.ing in CTF "
