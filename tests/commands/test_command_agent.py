...
from cybersentry.repl.commands.agent import AgentCommand
...
class TestAgentCommand:
    ...
    def setup_and_cleanup(self):
        ...
        env_vars_to_clear = [
            "Cybersentry_AGENT_TYPE",
            "CTF_MODEL",
            "Cybersentry_CODE_MODEL",
            "Cybersentry_TEST_MODEL",
            "Cybersentry_CUSTOM_MODEL",
        ]
    ...
    def test_command_initialization(self, agent_command):
        ...
        assert agent_command.cybe4sent1neles == ["/a"]
    ...
    def test_get_model_display_with_env_var(self, agent_command):
        ...
        os.environ["cybersentry_TEST_MODEL"] = "custom-model"
    ...
    @patch("cybersentry.repl.commands.agent.get_available_agents")
    @patch("cybersentry.repl.commands.agent.get_agent_module")
    ...
    @patch("cybersentry.repl.commands.agent.get_available_agents")
    @patch("cybersentry.repl.commands.agent.visualize_agent_graph")
    def test_handle_select_by_name(
        ...
        assert result is True
        assert os.environ.get("Cybersentry_AGENT_TYPE") == "blueteam_agent"
    ...
    def test_handle_select_by_number(
        ...
        # Clear cybersentry_AGENT_TYPE to ensure clean test
        if "cybersentry_AGENT_TYPE" in os.environ:
            del os.environ["cybersentry_AGENT_TYPE"]
        ...
        if result is False:
            ...
            assert "Cybersentry_AGENT_TYPE" not in os.environ
        else:
            ...
            assert os.environ.get("Cybersentry_AGENT_TYPE") == expected_key
    ...
    def test_handle_current_single_agent(self, mock_get_agents, agent_command, mock_agents):
        ...
        mock_get_agents.return_value = mock_agents
        os.environ["Cybersentry_AGENT_TYPE"] = "blueteam_agent"
        os.environ["Cybersentry_PARALLEL"] = "1"  # Ensure single agent mode
    ...
    def test_handle_current_agent_not_found(self, mock_get_agents, agent_command, mock_agents):
        ...
        mock_get_agents.return_value = mock_agents
        os.environ["Cybersentry_AGENT_TYPE"] = "nonexistent_agent"
        os.environ["Cybersentry_PARALLEL"] = "1"
    ...
    def test_handle_current_parallel_mode(self, mock_get_agents, agent_command):
        ...
        from cybersentry.repl.commands.parallel import ParallelConfig, PARALLEL_CONFIGS
        ...
        try:
            ...
            # Set parallel mode
            os.environ["Cybersentry_PARALLEL"] = "2"
            ...
            if "Cybersentry_PARALLEL" in os.environ:
                del os.environ["Cybersentry_PARALLEL"]
    ...
    def test_command_base_functionality(self, agent_command):
        ...
        assert agent_command.name == "/agent"
        assert "/a" in agent_command.cybe4sent1neles
...
class TestAgentCommandIntegration:
    ...
    @patch("cybersentry.repl.commands.agent.get_agent_module")
    @patch("cybersentry.repl.commands.agent.visualize_agent_graph")
    @patch("cybersentry.agents.get_agent_by_name")
    def test_full_workflow(self, mock_get_agent_by_name, mock_visualize, mock_get_module, mock_get_agents):
        ...
        assert result2 is True
        assert os.environ.get("Cybersentry_AGENT_TYPE") == "agent1"
        ...
        assert os.environ.get("Cybersentry_AGENT_TYPE") == "agent3"
    ...
    def test_environment_variable_handling(self, mock_get_agents):
        ...
        os.environ["Cybersentry_TEST_MODEL"] = "env-specific-model"
