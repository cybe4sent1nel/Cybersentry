...
from cybersentry.repl.commands.base import Command
from cybersentry.repl.commands.help import HelpCommand
...
class TestHelpCommand:
    ...
    def mock_console(self):
        ...
        with patch("cybersentry.repl.commands.help.console") as mock_console:
            yield mock_console
    ...
    def mock_commands_registry(self):
        ...
        with patch("cybersentry.repl.commands.help.COMMANDS", mock_registry):
            yield mock_registry

    @pytest.fixture
    def mock_cybe4sent1neles_registry(self):
        """Create a mock cybe4sent1neles registry for testing."""
        mock_cybe4sent1neles = {"/h": "/help", "/m": "/memory", "/a": "/agent"}

        with patch("cybersentry.repl.commands.help.COMMAND_CYBERSENTRY", mock_cybe4sent1neles):
            yield mock_cybe4sent1neles
    ...
    def test_command_initialization(self, help_command):
        ...
        assert "/h" in help_command.cybe4sent1neles
    ...
    def test_handle_memory_subcommand(self, help_command, mock_console):
        ...
        with patch("cybersentry.repl.commands.help.COMMANDS", {"/memory": mock_memory_cmd}):
    ...
    def test_handle_platform_subcommand_with_show_help(self, help_command, mock_console):
        ...
        with patch("cybersentry.repl.commands.help.COMMANDS", {"/platform": mock_platform_cmd}):
    ...
    def test_handle_platform_subcommand_fallback(self, help_command, mock_console):
        ...
        with patch("cybersentry.repl.commands.help.COMMANDS", {}):
            result = help_command.handle_platform()
    ...
    def test_handle_env_subcommand(self, help_command, mock_console):
        ...
        assert "Cybersentry_MODEL" in panel_content

    def test_handle_cybe4sent1neles_subcommand(self, help_command, mock_console, mock_cybe4sent1neles_registry):
        """Test cybe4sent1neles subcommand help."""
        result = help_command.handle_cybe4sent1neles()
    ...
    def test_handle_help_cybe4sent1neles(
        self, help_command, mock_console, mock_commands_registry, mock_cybe4sent1neles_registry
    ):
        """Test handle_help_cybe4sent1neles method directly."""
        result = help_command.handle_help_cybe4sent1neles()
    ...
    def test_handle_help_platform_manager_with_extensions(self, help_command, mock_console):
        ...
        with patch("cybersentry.repl.commands.help.HAS_PLATFORM_EXTENSIONS", True):
            with patch(
                "cybersentry.is_cybersentryextensions_platform_available", return_value=True
            ):
                # Mock the platform manager without importing cybersentryextensions
                with patch(
                    "sys.modules",
                    {"cybersentryextensions.platform.base": Mock(platform_manager=mock_platform_manager)},
                ):
    ...
    def test_handle_help_platform_manager_no_extensions(self, help_command, mock_console):
        ...
        with patch("cybersentry.repl.commands.help.HAS_PLATFORM_EXTENSIONS", False):
            result = help_command.handle_help_platform_manager()
    ...
    def test_create_styled_table_function(self):
        ...
        from cybersentry.repl.commands.help import create_styled_table
    ...
    def test_create_notes_panel_function(self):
        ...
        from cybersentry.repl.commands.help import create_notes_panel
    ...
    def test_handle_platform_with_import_error(self, help_command, mock_console):
        ...
        with patch("cybersentry.repl.commands.help.HAS_PLATFORM_EXTENSIONS", True):
            with patch(
                "cybersentry.is_cybersentryextensions_platform_available", return_value=False
            ):
                result = help_command.handle_help_platform_manager()
    ...
    def test_handle_cybe4sent1neles_with_empty_registry(self, help_command, mock_console):
        """Test cybe4sent1neles help with empty cybe4sent1neles registry."""
        with patch("cybersentry.repl.commands.help.COMMAND_CYBERSENTRY", {}):
            with patch("cybersentry.repl.commands.help.COMMANDS", {}):
                result = help_command.handle_help_cybe4sent1neles()
    ...
    def test_subcommand_with_none_args(self, help_command):
        ...
        result6 = help_command.handle_cybe4sent1neles(None)
