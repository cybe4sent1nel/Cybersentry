...
from cybersentry.repl.commands.load import LoadCommand
...
class TestLoadCommand:
    ...
    def test_command_initialization(self, load_command):
        ...
        assert load_command.cybe4sent1neles == ["/l"]

    @patch("cybersentry.repl.commands.load.console.input")
    @patch("cybersentry.agents.get_agent_by_name")
    @patch("cybersentry.sdk.agents.simple_agent_manager.AGENT_MANAGER")
    @patch("cybersentry.sdk.agents.models.openai_chatcompletions.ACTIVE_MODEL_INSTANCES", {})
    @patch("cybersentry.sdk.agents.models.openai_chatcompletions.PERSISTENT_MESSAGE_HISTORIES", {})
    @patch("cybersentry.repl.commands.load.load_history_from_jsonl")
    ...
    @patch("cybersentry.repl.commands.load.get_all_agent_histories")
    ...
    @patch("cybersentry.repl.commands.load.load_history_from_jsonl")
    @patch("cybersentry.repl.commands.load.get_agent_message_history")
    ...
    @patch("cybersentry.agents.get_available_agents")
    @patch("cybersentry.repl.commands.load.get_all_agent_histories")
    ...
    def test_command_base_functionality(self, load_command):
        ...
        assert load_command.name == "/load"
        assert "/l" in load_command.cybe4sent1neles
