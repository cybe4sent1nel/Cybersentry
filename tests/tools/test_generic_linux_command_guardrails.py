...
def _enable_guardrails(monkeypatch):
    monkeypatch.setenv("Cybersentry_GUARDRAILS", "true")
...
async def test_blocks_unicode_homograph_bypass_with_env_exfiltration():
    ...
    import cybersentry.tools.reconnaissance.generic_linux_command as glc
    from cybersentry.sdk.agents.run_context import RunContextWrapper
