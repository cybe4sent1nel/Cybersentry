...
try:
    from cybersentry.sdk.agents.voice import OpenAISTTTranscriptionSession, StreamedAudioInput, STTModelSettings
    from cybersentry.sdk.agents.voice.exceptions import STTWebsocketConnectionError
    from cybersentry.sdk.agents.voice.models.openai_stt import EVENT_INACTIVITY_TIMEOUT
