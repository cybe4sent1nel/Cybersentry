...
<head>
  ...
  <title>Case Study - Cybersentry-powered API vulnerability discovery at Mercado Libre</title>
  <link rel="stylesheet" href="css/use-case.css">
  <link rel="stylesheet" href="css/about.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/Wruczek/Bootstrap-Cookie-Alert@gh-pages/cookiealert.css">
  <link href="css/worksans.css" rel="stylesheet">
  <meta name="description" content="Cybersentry (SEC-AI) framework discovers and demonstrates API vulnerabilities at Mercado Libre through automated enumeration attacks. AI-powered security testing reveals user data exposure risks." />
          ...
          <div class="container">
            <div class="row">
              <div class="col-12 col-sm-12 col-lg-12 col-xl-12 pt-5">
                ...
                <h2 class="py-4"><a style="color:#63bfab">Cybersecurity AI (Cybersentry)</a>, the <i>de facto</i> scaffolding for building AI security</h2>
                <p class="pb-2">
                  Cybersentry represents the first open-source framework specifically designed to democratize advanced security testing through specialized AI agents. By 2028, most cybersecurity actions will be autonomous, with humans teleoperating, making Cybersentry's approach to AI-powered vulnerability discovery increasingly critical for organizational security.
                  The framework transcends theoretical benchmarks by enabling practical security outcomes. Cybersentry achieved first place among AI teams and secured a top-20 position worldwide in the "AI vs Human" CTF live Challenge, earning a monetary reward and various other prizes and bounties ever since then. This performance demonstrates that AI-powered security testing can compete with and often exceed human capabilities in vulnerability discovery.
                </p>
                <a href="https://github.com/cybe4sent1nel(FAHAD KHAN)/Cybersentry" class="btn btn-relleno find-more">Explore Cybersentry's source code <span>&#10095;</span></a>                                                  
              </div>              
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-6 col-lg-2 col-xl-2">
            ...
            <p style="color:#333333">
              Tool:<br> 
              <a style="color:#63bfab">Cybersentry</a> 
          ...
          <div class="col-6 col-lg-2 col-xl-2">
            ...
            <p style="color:#333333">
              ...
              <a style="color:#63bfab; font-family: SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;">Neural x SEC</a>
            </p>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-lg-6 mb-4">
                  <div class="summary-card p-4" style="background: rgba(255,255,255,0.9); border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); height: 100%;">
                    ...
                    <p style="color: #333; font-size: 1.1rem; line-height: 1.6;">
                      To validate and demonstrate the risk, the Cybersentry framework was deployed to script and run enumeration attacks in a controlled environment. By using multi-threaded concurrent requests and dynamic progress tracking, Cybersentry provided concrete evidence of the vulnerability's scale and impact. Key metrics such as enumeration success rate, location-based user distributions, and response latencies were recorded. These results provided actionable intelligence for reporting the issue to Mercado Libre's security response team.
                    </p>
                ...
                <div class="col-12 col-lg-6 mb-4">
                  <div class="summary-card p-4" style="background: rgba(255,255,255,0.9); border-radius: 10px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); height: 100%;">
                    ...
                    <ul style="color: #333; font-size: 1.1rem; line-height: 1.6; margin: 0; padding-left: 20px;">
                      <li>Custom-built Cybersentry automation script for user profile enumeration</li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-12 col-xl-12 pb-5" style="margin-bottom:3em;">
            <a href="https://github.com/cybe4sent1nel(FAHAD KHAN)/Cybersentry" class="btn btn-relleno find-more">Use Cybersentry <span>&#10095;</span></a>
            <!-- TEMPLATE: the following button should be shown only if Neural x SEC is the model used -->
            <a href="https://github.com/cybe4sent1nel(FAHAD KHAN)/Cybersentry" class="btn btn-linea find-more">Learn about <b style="color:#63bfab; font-family: SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace;">Neural x SEC</b> <span>&#10095;</span></a>
          </div>
        </div>
      </div>
    </div>
